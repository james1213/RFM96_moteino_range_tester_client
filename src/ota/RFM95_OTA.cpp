...
////===================================================================================================================
//void CheckForWirelessHEX(RadioOta& radio, SPIFlash& flash, uint8_t DEBUG, uint8_t LEDpin)
//{
//
//    Serial.println(F("RFM95_OTA | CheckForWirelessHEX()"));
//    Serial.print(F("RFM95_OTA | CheckForWirelessHEX(), radio.DATALEN = "));
//    Serial.println(radio.DATALEN);
//    Serial.print(F("RFM95_OTA | CheckForWirelessHEX(), DATA[0] = "));
//    Serial.println((char) radio.DATA[0]);
//    Serial.print(F("RFM95_OTA | CheckForWirelessHEX(), DATA[1] = "));
//    Serial.println((char) radio.DATA[1]);
//    Serial.print(F("RFM95_OTA | CheckForWirelessHEX(), DATA[2] = "));
//    Serial.println((char) radio.DATA[2]);
//    Serial.print(F("RFM95_OTA | CheckForWirelessHEX(), DATA[3] = "));
//    Serial.println((char) radio.DATA[3]);
...
//    {
//        Serial.println(F("RFM95_OTA | CheckForWirelessHEX(), inside if"));
...
////===================================================================================================================
//uint8_t HandleHandshakeACK(RadioOta& radio, SPIFlash& flash, uint8_t flashCheck) {
//    if (flashCheck)
//    {
//        uint16_t deviceID=0;
...
//// this is called at the OTA programmer side
////===================================================================================================================
//uint8_t CheckForSerialHEX(uint8_t* input, uint8_t inputLen, RadioOta& radio, uint16_t targetID, uint16_t TIMEOUT, uint16_t ACKTIMEOUT, uint8_t DEBUG)
//{
//    Serial.print(F("\nCheckForSerialHEX()"));
////    Serial.print(F("RFM95_OTA | CheckForSerialHEX(), inputLen = "));
////    Serial.println(inputLen);
////    Serial.print(F("RFM95_OTA | CheckForSerialHEX(), input[0] = "));
////    Serial.println((char) input[0]);
////    Serial.print(F("RFM95_OTA | CheckForSerialHEX(), input[1] = "));
////    Serial.println((char) input[1]);
////    Serial.print(F("RFM95_OTA | CheckForSerialHEX(), input[2] = "));
////    Serial.println((char) input[2]);
...
////===================================================================================================================
//uint8_t HandleSerialHandshake(RadioOta& radio, uint16_t targetID, uint8_t isEOF, uint16_t TIMEOUT, uint16_t ACKTIMEOUT, uint8_t DEBUG)
//{
//    long now = millis();
//
